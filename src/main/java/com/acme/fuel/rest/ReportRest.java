...
public class ReportRest {
	...
	public Iterable<MoneyByMonth> moneyByMonth(@RequestParam Long driverId) {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = SUCCESSFULLY_RETRIEVED_REPORT) })
	@GetMapping(path = "/consumption-by-month")
	public Iterable<MonthlyConsumption> consumptionByMonth(@RequestParam Long driverId) {
		return service.consumptionByMonth(driverId);
	}
	...
	public Iterable<ConsumptionByFuelType> consumptionByFuelType(@RequestParam Long driverId) {
